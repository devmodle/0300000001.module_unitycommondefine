...
- 61 ~ 69 : 참조 (기본) 형식 데이터
- 71 ~ 79 : 참조 (복합) 형식 데이터
- 81 ~ 89 : 참조 (복합) 형식 데이터 (리스트 or 셋 or 딕셔너리)

셋 형식 데이터 세부 범위 :
- 91 ~ 99 : 값 (기본) 형식 데이터
- 101 ~ 109 : 값 (열거형) 형식 데이터
- 111 ~ 119 : 값 (복합) 형식 데이터
- 121 ~ 129 : 참조 (기본) 형식 데이터
- 131 ~ 139 : 참조 (복합) 형식 데이터
- 141 ~ 149 : 참조 (복합) 형식 데이터 (리스트 or 셋 or 딕셔너리)

딕셔너리 형식 데이터 세부 범위 :
- 151 ~ 159 : 값 (기본) 형식 데이터
- 161 ~ 169 : 값 (열거형) 형식 데이터
- 171 ~ 179 : 값 (복합) 형식 데이터
- 181 ~ 189 : 참조 (기본) 형식 데이터
- 191 ~ 199 : 참조 (복합) 형식 데이터
- 201 ~ 209 : 참조 (복합) 형식 데이터 (리스트 or 셋 or 딕셔너리)
*/
#region 기본
//! 마우스 버튼
