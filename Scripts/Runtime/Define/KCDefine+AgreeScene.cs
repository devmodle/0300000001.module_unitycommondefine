...
public static partial class KCDefine {
	...
	public const string AS_OBJ_NAME_SERVICES_URL_BTN = "ServicesURLBtn";
	public const string AS_OBJ_NAME_PRIVACY_URL_BTN = "PrivacyURLBtn";
	...
	public static readonly string AS_OBJ_PATH_AGREE_POPUP = string.Format("{0}{1}AgreePopup", KCDefine.B_DIR_PATH_PREFABS, KCDefine.B_DIR_PATH_AGREE_SCENE);
	// 경로 }
	#endregion			// 런타임 상수
}
