...
public static partial class KCEditorDefine {
	...
	// 버전
	public const string B_VER_UNITY_MODULE = "2.5.6";
	...
	// 패키지
	public const string B_NAME_ODIN_INSPECTOR_PKGS = "OdinInspector-3.0.13";
	...
	public static readonly string B_ABS_PKGS_P_ODIN_INSPECTOR_PKGS = $"{KCEditorDefine.B_ABS_DIR_P_ASSETS}../UnityPackages/Packages/UnityPackages/{KCEditorDefine.B_NAME_ODIN_INSPECTOR_PKGS}.unitypackage";
	...
	public static readonly List<(string, string)> B_SCRIPT_P_INFO_LIST = new List<(string, string)>() {
		...
		($"{KCEditorDefine.B_ABS_DIR_P_SCRIPT_TEMPLATES}Runtime/Popup/T_CCoinsBoxCoinsAcquirePopup.cs", $"{KCEditorDefine.B_ABS_DIR_P_ASSETS}{KCEditorDefine.B_DIR_P_SUB_UNITY_PROJ}Scripts/Runtime/Global/Popup/CCoinsBoxCoinsAcquirePopup.cs"),
	...
	public static readonly List<(string, string)> B_PREFAB_P_INFO_LIST = new List<(string, string)>() {
		...
		($"{KCEditorDefine.B_DIR_P_PREFAB_TEMPLATES}{KCDefine.B_DIR_P_POPUP_ROOT}T_Popup.prefab", $"{KCEditorDefine.B_DIR_P_SUB_UNITY_PROJ_RESOURCES}{KCDefine.U_OBJ_P_G_COINS_BOX_COINS_ACQUIRE_POPUP}.prefab"),
