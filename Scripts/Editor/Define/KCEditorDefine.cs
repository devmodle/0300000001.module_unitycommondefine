...
public static partial class KCEditorDefine {
	...
	public static readonly string B_ABSOLUTE_DIR_PATH_PACKAGES = string.Format("{0}../Packages/", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS);
	public static readonly string B_ABSOLUTE_DIR_PATH_UNITY_ENGINE = string.Format("{0}/", EditorApplication.applicationPath);

	public static readonly string B_ABSOLUTE_DIR_PATH_SAMPLE_SCENE = string.Format("{0}.UnityModule.Common/Scenes/SampleScene.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES);
	public static readonly string B_ABSOLUTE_DIR_PATH_STUDY_SAMPLE_SCENE = string.Format("{0}.UnityModule.Study/Scenes/SampleScene.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES);
	...
	public static readonly string B_ABSOLUTE_DIR_PATH_TEMPLATES = string.Format("{0}.UnityModule.Common/Templates/", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES);
	...
	public static readonly string B_DATA_PATH_UNITY_PKGS = string.Format("{0}manifest.json", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES);
	...
	public static readonly KeyValuePair<string, string>[] B_PATH_SCRIPT_FILEPATH_INFOS = new KeyValuePair<string, string>[] {
		new KeyValuePair<string, string>(string.Format("{0}Editor/Define/T_KEditorDefine.cs", KCEditorDefine.B_ABSOLUTE_DIR_PATH_SCRIPT_TEMPLATES),
		...
		new KeyValuePair<string, string>(string.Format("{0}Runtime/Define/T_KDefine.cs", KCEditorDefine.B_ABSOLUTE_DIR_PATH_SCRIPT_TEMPLATES),
		...
		new KeyValuePair<string, string>(string.Format("{0}Runtime/Define/T_KDefine+Type.cs", KCEditorDefine.B_ABSOLUTE_DIR_PATH_SCRIPT_TEMPLATES),
		...
		new KeyValuePair<string, string>(string.Format("{0}Runtime/Storage/T_CGameInfoStorage.cs", KCEditorDefine.B_ABSOLUTE_DIR_PATH_SCRIPT_TEMPLATES),
			string.Format("{0}{1}Scripts/Runtime/Global/Utility/Storage/CGameInfoStorage.cs", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, KCEditorDefine.B_DIR_PATH_AUTO_CREATE)),
	...
	public static readonly KeyValuePair<string, string>[] B_PATH_PREFAB_FILEPATH_INFOS = new KeyValuePair<string, string>[] {
		...
		new KeyValuePair<string, string>(string.Format("{0}.UnityModule.Common.Externals/Externals/OmniSARTechnologies/LiteFPSCounter/Prefabs/LiteFPSCounter.prefab", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES),
	...
	public static readonly KeyValuePair<string, string>[] B_PATH_SCENE_FILEPATH_INFOS = new KeyValuePair<string, string>[] {
		new KeyValuePair<string, string>(KCEditorDefine.B_ABSOLUTE_DIR_PATH_SAMPLE_SCENE,
			string.Format("{0}{1}Scenes/{2}.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, KCEditorDefine.B_DIR_PATH_AUTO_CREATE, KCDefine.B_SCENE_NAME_INIT)),

		new KeyValuePair<string, string>(KCEditorDefine.B_ABSOLUTE_DIR_PATH_SAMPLE_SCENE,
			string.Format("{0}{1}Scenes/{2}.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, KCEditorDefine.B_DIR_PATH_AUTO_CREATE, KCDefine.B_SCENE_NAME_SETUP)),

		new KeyValuePair<string, string>(KCEditorDefine.B_ABSOLUTE_DIR_PATH_SAMPLE_SCENE,
			string.Format("{0}{1}Scenes/{2}.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, KCEditorDefine.B_DIR_PATH_AUTO_CREATE, KCDefine.B_SCENE_NAME_START)),

		new KeyValuePair<string, string>(KCEditorDefine.B_ABSOLUTE_DIR_PATH_SAMPLE_SCENE,
			string.Format("{0}{1}Scenes/{2}.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, KCEditorDefine.B_DIR_PATH_AUTO_CREATE, KCDefine.B_SCENE_NAME_LOADING)),

		new KeyValuePair<string, string>(KCEditorDefine.B_ABSOLUTE_DIR_PATH_SAMPLE_SCENE,
			string.Format("{0}{1}Scenes/{2}.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, KCEditorDefine.B_DIR_PATH_AUTO_CREATE, KCDefine.B_SCENE_NAME_SPLASH)),

		new KeyValuePair<string, string>(KCEditorDefine.B_ABSOLUTE_DIR_PATH_SAMPLE_SCENE,
			string.Format("{0}{1}Scenes/{2}.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, KCEditorDefine.B_DIR_PATH_AUTO_CREATE, KCDefine.B_SCENE_NAME_AGREE)),

		new KeyValuePair<string, string>(KCEditorDefine.B_ABSOLUTE_DIR_PATH_SAMPLE_SCENE,
			string.Format("{0}{1}Scenes/{2}.unity", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, KCEditorDefine.B_DIR_PATH_AUTO_CREATE, KCDefine.B_SCENE_NAME_INTRO)),
	...
	public static readonly KeyValuePair<string, string>[] B_PATH_ASSEMBLY_DEFINITION_FILEPATH_INFOS = new KeyValuePair<string, string>[] {
#if FLURRY_ENABLE
		new KeyValuePair<string, string>(string.Format("{0}.UnityModule.Common.Flurry/Templates/T_UnityModule.FlurrySDK.asmdef.t", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES),
...
#if TENJIN_ENABLE
		new KeyValuePair<string, string>(string.Format("{0}.UnityModule.Common.Tenjin/Templates/T_UnityModule.Tenjin.asmdef.t", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES),
		...
		new KeyValuePair<string, string>(string.Format("{0}.UnityModule.Common.GameCenter/Templates/T_UnityModule.GooglePlayGames.asmdef.t", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES),
			string.Format("{0}GooglePlayGames/UnityModule.GooglePlayGames.asmdef", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS)),

		new KeyValuePair<string, string>(string.Format("{0}.UnityModule.Common.GameCenter/Templates/T_UnityModule.GooglePlayGames.Editor.asmdef.t", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES),
			string.Format("{0}GooglePlayGames/Editor/UnityModule.GooglePlayGames.Editor.asmdef", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS))
	...
	public static readonly Dictionary<string, string> B_UNITY_PKGS_SCOPED_REGISTRY_LIST = new Dictionary<string, string>() {
		[KCEditorDefine.B_UNITY_PKGS_GOOGLE_REGISTRY_NAME] = string.Format("{0}../UnityPackages/Options/Project/GoogleRegistry.json", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS)
	};
	// 유니티 패키지 }
	...
	// 독립 플랫폼
	public static readonly string B_STANDALONE_ABSOLUTE_BUILD_PATH_FORMAT = string.Format("{0}../Builds/Standalone/{1}", KCEditorDefine.B_ABSOLUTE_DIR_PATH_ASSETS, "{0}");
	...
	public static readonly string B_ANDROID_SRC_MANIFEST_PATH = string.Format("{0}Options/Android/AndroidManifest.xml", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES);
	...
	public static readonly string B_ANDROID_SRC_MAIN_TEMPLATE_PATH = string.Format("{0}Options/Android/mainTemplate.gradle", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES);
	...
	public static readonly string B_ANDROID_SRC_PROGUARD_PATH = string.Format("{0}Options/Android/proguard-user.txt", KCEditorDefine.B_ABSOLUTE_DIR_PATH_PACKAGES);
