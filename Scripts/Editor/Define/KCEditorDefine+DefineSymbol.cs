...
public static partial class KCEditorDefine {
	...
	public const string DS_DEFINE_S_MAIN_LIGHT_REALTIME_LIGHTMAP_BAKE_ENABLE = "MAIN_LIGHT_REALTIME_LIGHTMAP_BAKE_ENABLE";
	...
	public const string DS_DEFINE_S_IGNORE_ORGANIZATION_BUILD_PIPELINE_SETUP = "IGNORE_ORGANIZATION_BUILD_PIPELINE_SETUP";
	// 기타 }
	#endregion			// 기본
	...
	public static readonly Dictionary<string, string> DS_DEFINE_S_REPLACE_MODULE_DICT = new Dictionary<string, string>() {
		...
		[KCEditorDefine.DS_DEFINE_S_ADAPTIVE_PERFORMANCE_ENABLE] = KCEditorDefine.DS_DEFINE_S_ADAPTIVE_PERFORMANCE_MODULE_ENABLE,
