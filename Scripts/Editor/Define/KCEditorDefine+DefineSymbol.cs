...
public static partial class KCEditorDefine {
	...
	// 백엔드
	public const string DS_DEFINE_S_BACKEND_ENABLE = "BACKEND_ENABLE";
	public const string DS_DEFINE_S_BACKEND_MODULE_ENABLE = "BACKEND_MODULE_ENABLE";
	...
	public static readonly Dictionary<string, string> DS_DEFINE_S_REPLACE_MODULE_DICT = new Dictionary<string, string>() {
		...
		[KCEditorDefine.DS_DEFINE_S_BACKEND_ENABLE] = KCEditorDefine.DS_DEFINE_S_BACKEND_MODULE_ENABLE,
