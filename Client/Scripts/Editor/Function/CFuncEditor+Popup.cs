...
public static partial class CFuncEditor
{
	...
	{
		return CFuncEditor.ShowAlertPopup(a_oTitle, a_oMsg, KCDefineEditor.B_TEXT_OK, string.Empty);
	}

	/** 경고 팝업을 출력한다 */
	public static bool ShowOKCancelAlertPopup(string a_oTitle, string a_oMsg)
	{
		return CFuncEditor.ShowAlertPopup(a_oTitle, a_oMsg, KCDefineEditor.B_TEXT_OK, KCDefineEditor.B_TEXT_CANCEL);
	}
	#endregion // 클래스 함수
}
