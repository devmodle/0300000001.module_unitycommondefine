...
public static partial class KCEditorDefine
{
	...
	#region 런타임 상수
	// 기타
	public static readonly List<string> G_OPTS_EDITOR_EXTENSION_LIST = new List<string>() {
		"txt", "xml", "fnt", "cd", "asmdef", "rsp", "asmref"
	};

	// 단위
	public static readonly Vector2 G_OPTS_EDITOR_PERCENT_CASCADE_SPLIT_3 = new Vector2(KCEditorDefine.G_OPTS_EDITOR_PERCENT_CASCADE_SPLIT_2, KCEditorDefine.G_OPTS_EDITOR_PERCENT_CASCADE_SPLIT_2 + (0.1f * 2.0f));
	public static readonly Vector3 G_OPTS_EDITOR_PERCENT_CASCADE_SPLIT_4 = new Vector3(KCEditorDefine.G_OPTS_EDITOR_PERCENT_CASCADE_SPLIT_2, KCEditorDefine.G_OPTS_EDITOR_PERCENT_CASCADE_SPLIT_2 + (0.1f * 2.0f), 0.15f + (0.1f * 2.0f) + (0.1f * 3.0f));
	#endregion // 런타임 상수
}
