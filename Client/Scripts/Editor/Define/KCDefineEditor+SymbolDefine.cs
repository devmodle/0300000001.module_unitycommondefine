...
public static partial class KCDefineEditor
{
	...
	public const string DS_DEFINE_S_ENABLE_MODE_2D = "ENABLE_MODE_2D";
	public const string DS_DEFINE_S_ENABLE_MODE_PORTRAIT = "ENABLE_MODE_PORTRAIT";
	public const string DS_DEFINE_S_ENABLE_RAYCASTER_PHYSICS = "ENABLE_RAYCASTER_PHYSICS";
	public const string DS_DEFINE_S_ENABLE_MULTITOUCH = "ENABLE_MULTITOUCH";
	public const string DS_DEFINE_S_ENABLE_ANALYTICS_SERVICES = "ENABLE_ANALYTICS_SERVICES";
	public const string DS_DEFINE_S_ENABLE_STORAGE_EXTERNAL = "ENABLE_STORAGE_EXTERNAL";
	public const string DS_DEFINE_S_ENABLE_ADAPTIVEPERFORMANCE = "ENABLE_ADAPTIVEPERFORMANCE";
	...
	// 플러그인
	public const string DS_DEFINE_S_ENABLE_LOGIN_APPLE = "ENABLE_LOGIN_APPLE";
	public const string DS_DEFINE_S_ENABLE_GOOGLESHEET = "ENABLE_GOOGLESHEET";
	public const string DS_DEFINE_S_ENABLE_TABLE_REMOTE = "ENABLE_TABLE_REMOTE";
	public const string DS_DEFINE_S_ENABLE_UPDATE_GOOGLE_ANDROID = "ENABLE_UPDATE_GOOGLE_ANDROID";
	...
	// 외부 에셋 {
	public const string DS_DEFINE_S_EXTERNAL_NGUI_ENABLE = "EXTERNAL_NGUI_ENABLE";
	public const string DS_DEFINE_S_EXTERNAL_2D_TOOLKIT_ENABLE = "EXTERNAL_2D_TOOLKIT_ENABLE";
	public const string DS_DEFINE_S_EXTERNAL_SPRITE_TRAIL_ENABLE = "EXTERNAL_SPRITE_TRAIL_ENABLE";
	public const string DS_DEFINE_S_EXTERNAL_SND_MANAGER_PRO_ENABLE = "EXTERNAL_SND_MANAGER_PRO_ENABLE";
	public const string DS_DEFINE_S_EXTERNAL_ULTIMATE_STATUS_BAR_ENABLE = "EXTERNAL_ULTIMATE_STATUS_BAR_ENABLE";
	...
	public const string DS_DEFINE_S_ADDITIONAL_LIGHTS_PIXEL_RENDERING_ENABLE = "ADDITIONAL_LIGHTS_PIXEL_RENDERING_ENABLE";

	public const string DS_DEFINE_S_URP_ENABLE = "URP_ENABLE";
	public const string DS_DEFINE_S_URP_MODULE_ENABLE = "URP_MODULE_ENABLE";
	public const string DS_DEFINE_S_URP_POST_PROCESSING_ENABLE = "URP_POST_PROCESSING_ENABLE";
	// 렌더링 }
	...
	public const string DS_DEFINE_S_UNI_TASK_ENABLE = "UNI_TASK_ENABLE";
	public const string DS_DEFINE_S_UNI_TASK_MODULE_ENABLE = "UNI_TASK_MODULE_ENABLE";
	...
	public const string DS_DEFINE_S_UIS_ROOT_PREFAB_ENABLE = "UIS_ROOT_PREFAB_ENABLE";
	...
	public const string DS_DEFINE_S_SPRITE_PIXELS_PER_UNIT_ADJUST_ENABLE = "SPRITE_PIXELS_PER_UNIT_ADJUST_ENABLE";
	...
	public const string DS_DEFINE_S_RESEARCH_ENABLE = "RESEARCH_ENABLE";
	public const string DS_DEFINE_S_RESEARCH_MODULE_ENABLE = "RESEARCH_MODULE_ENABLE";
	...
	public const string DS_DEFINE_S_BURST_ENABLE = "BURST_ENABLE";
	public const string DS_DEFINE_S_BURST_MODULE_ENABLE = "BURST_MODULE_ENABLE";
	...
	public static readonly Dictionary<string, string> DS_DEFINE_S_REPLACE_MODULE_DICT = new Dictionary<string, string>()
	{
		...
		[KCDefineEditor.DS_DEFINE_S_EXTRA_SCRIPT_ENABLE] = KCDefineEditor.DS_DEFINE_S_EXTRA_SCRIPT_MODULE_ENABLE,
#endif // #if EXTRA_SCRIPT_ENABLE || EXTRA_SCRIPT_MODULE_ENABLE

#if UNI_TASK_ENABLE || UNI_TASK_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_UNI_TASK_ENABLE] = KCDefineEditor.DS_DEFINE_S_UNI_TASK_MODULE_ENABLE,
#endif // #if UNI_TASK_ENABLE || UNI_TASK_MODULE_ENABLE

#if ADDRESSABLES_ENABLE || ADDRESSABLES_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_ADDRESSABLES_ENABLE] = KCDefineEditor.DS_DEFINE_S_ADDRESSABLES_MODULE_ENABLE,
#endif // #if ADDRESSABLES_ENABLE || ADDRESSABLES_MODULE_ENABLE

#if BURST_ENABLE || BURST_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_BURST_ENABLE] = KCDefineEditor.DS_DEFINE_S_BURST_MODULE_ENABLE,
#endif // #if BURST_ENABLE || BURST_MODULE_ENABLE

#if CINEMACHINE_ENABLE || CINEMACHINE_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_CINEMACHINE_ENABLE] = KCDefineEditor.DS_DEFINE_S_CINEMACHINE_MODULE_ENABLE,
#endif // #if CINEMACHINE_ENABLE || CINEMACHINE_MODULE_ENABLE

#if LOCALIZE_ENABLE || LOCALIZE_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_LOCALIZE_ENABLE] = KCDefineEditor.DS_DEFINE_S_LOCALIZE_MODULE_ENABLE,
#endif // #if LOCALIZE_ENABLE || LOCALIZE_MODULE_ENABLE

#if INPUT_SYSTEM_ENABLE || INPUT_SYSTEM_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_INPUT_SYSTEM_ENABLE] = KCDefineEditor.DS_DEFINE_S_INPUT_SYSTEM_MODULE_ENABLE,
#endif // #if INPUT_SYSTEM_ENABLE || INPUT_SYSTEM_MODULE_ENABLE

#if SKELETON_2D_ANI_ENABLE || SKELETON_2D_ANI_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_SKELETON_2D_ANI_ENABLE] = KCDefineEditor.DS_DEFINE_S_SKELETON_2D_ANI_MODULE_ENABLE,
#endif // #if SKELETON_2D_ANI_ENABLE || SKELETON_2D_ANI_MODULE_ENABLE

#if URP_ENABLE || URP_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_URP_ENABLE] = KCDefineEditor.DS_DEFINE_S_URP_MODULE_ENABLE,
#endif // #if URP_ENABLE || URP_MODULE_ENABLE

#if ADS_ENABLE || ADS_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_ADS_ENABLE] = KCDefineEditor.DS_DEFINE_S_ADS_MODULE_ENABLE,
#endif // #if ADS_ENABLE || ADS_MODULE_ENABLE

#if FLURRY_ENABLE || FLURRY_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_FLURRY_ENABLE] = KCDefineEditor.DS_DEFINE_S_FLURRY_MODULE_ENABLE,
#endif // #if FLURRY_ENABLE || FLURRY_MODULE_ENABLE

#if FACEBOOK_ENABLE || FACEBOOK_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_FACEBOOK_ENABLE] = KCDefineEditor.DS_DEFINE_S_FACEBOOK_MODULE_ENABLE,
#endif // #if FACEBOOK_ENABLE || FACEBOOK_MODULE_ENABLE

#if FIREBASE_ENABLE || FIREBASE_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_FIREBASE_ENABLE] = KCDefineEditor.DS_DEFINE_S_FIREBASE_MODULE_ENABLE,
#endif // #if FIREBASE_ENABLE || FIREBASE_MODULE_ENABLE

#if SINGULAR_ENABLE || SINGULAR_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_SINGULAR_ENABLE] = KCDefineEditor.DS_DEFINE_S_SINGULAR_MODULE_ENABLE,
#endif // #if SINGULAR_ENABLE || SINGULAR_MODULE_ENABLE

#if APPS_FLYER_ENABLE || APPS_FLYER_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_APPS_FLYER_ENABLE] = KCDefineEditor.DS_DEFINE_S_APPS_FLYER_MODULE_ENABLE,
#endif // #if APPS_FLYER_ENABLE || APPS_FLYER_MODULE_ENABLE

#if GAME_CENTER_ENABLE || GAME_CENTER_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_GAME_CENTER_ENABLE] = KCDefineEditor.DS_DEFINE_S_GAME_CENTER_MODULE_ENABLE,
#endif // #if GAME_CENTER_ENABLE || GAME_CENTER_MODULE_ENABLE

#if PURCHASE_ENABLE || PURCHASE_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_PURCHASE_ENABLE] = KCDefineEditor.DS_DEFINE_S_PURCHASE_MODULE_ENABLE,
#endif // #if PURCHASE_ENABLE || PURCHASE_MODULE_ENABLE

#if NOTI_ENABLE || NOTI_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_NOTI_ENABLE] = KCDefineEditor.DS_DEFINE_S_NOTI_MODULE_ENABLE,
#endif // #if NOTI_ENABLE || NOTI_MODULE_ENABLE

#if PLAYFAB_ENABLE || PLAYFAB_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_PLAYFAB_ENABLE] = KCDefineEditor.DS_DEFINE_S_PLAYFAB_MODULE_ENABLE,
#endif // #if PLAYFAB_ENABLE || PLAYFAB_MODULE_ENABLE

#if SCENE_TEMPLATES_ENABLE || SCENE_TEMPLATES_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_SCENE_TEMPLATES_ENABLE] = KCDefineEditor.DS_DEFINE_S_SCENE_TEMPLATES_MODULE_ENABLE,
		...
		[KCDefineEditor.DS_DEFINE_S_EDITOR_SCENE_TEMPLATES_ENABLE] = KCDefineEditor.DS_DEFINE_S_EDITOR_SCENE_TEMPLATES_MODULE_ENABLE,
		...
		[KCDefineEditor.DS_DEFINE_S_PREFAB_TEMPLATES_ENABLE] = KCDefineEditor.DS_DEFINE_S_PREFAB_TEMPLATES_MODULE_ENABLE,
		...
		[KCDefineEditor.DS_DEFINE_S_POPUP_PREFAB_TEMPLATES_ENABLE] = KCDefineEditor.DS_DEFINE_S_POPUP_PREFAB_TEMPLATES_MODULE_ENABLE,
		...
		[KCDefineEditor.DS_DEFINE_S_UTILITY_SCRIPT_TEMPLATES_ENABLE] = KCDefineEditor.DS_DEFINE_S_UTILITY_SCRIPT_TEMPLATES_MODULE_ENABLE,
#endif // #if UTILITY_SCRIPT_TEMPLATES_ENABLE || UTILITY_SCRIPT_TEMPLATES_MODULE_ENABLE

#if RESEARCH_ENABLE || RESEARCH_MODULE_ENABLE
		[KCDefineEditor.DS_DEFINE_S_RESEARCH_ENABLE] = KCDefineEditor.DS_DEFINE_S_RESEARCH_MODULE_ENABLE
