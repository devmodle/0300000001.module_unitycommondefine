...
public static partial class KCDefineEditor
{
	...
	#region 런타임 상수
	// 기타 {
	public static readonly string B_JENKINS_IOS_PIPELINE = string.Format($"{KCDefineEditor.B_PIPELINE_GROUP_NAME_FMT_JENKINS}/01.iOS",
		KCDefineEditor.B_VER_UNITY_MODULE);

	public static readonly string B_JENKINS_ANDROID_PIPELINE = string.Format($"{KCDefineEditor.B_PIPELINE_GROUP_NAME_FMT_JENKINS}/11.Android",
		KCDefineEditor.B_VER_UNITY_MODULE);

	public static readonly string B_JENKINS_STANDALONE_PIPELINE = string.Format($"{KCDefineEditor.B_PIPELINE_GROUP_NAME_FMT_JENKINS}/41.Standalone",
		KCDefineEditor.B_VER_UNITY_MODULE);
	...
	public static readonly Dictionary<EiOSType, Dictionary<string, string>> B_JENKINS_IOS_SOURCES = new Dictionary<EiOSType, Dictionary<string, string>>()
	{
		...
		{
			[KCDefineEditor.B_DEBUG_BUILD_FUNC_JENKINS] = "01.iOSAppleDebug",
			[KCDefineEditor.B_RELEASE_BUILD_FUNC_JENKINS] = "11.iOSAppleRelease",
			[KCDefineEditor.B_STORE_A_BUILD_FUNC_JENKINS] = "21.iOSAppleStoreA",
			[KCDefineEditor.B_STORE_DIST_BUILD_FUNC_JENKINS] = "31.iOSAppleStoreDist"
		}
	};
	...
	public static readonly Dictionary<EAndroidType, Dictionary<string, string>> B_JENKINS_ANDROID_SOURCES = new Dictionary<EAndroidType, Dictionary<string, string>>()
	{
		...
		{
			[KCDefineEditor.B_DEBUG_BUILD_FUNC_JENKINS] = "01.AndroidGoogleDebug",
			[KCDefineEditor.B_RELEASE_BUILD_FUNC_JENKINS] = "11.AndroidGoogleRelease",
			[KCDefineEditor.B_STORE_A_BUILD_FUNC_JENKINS] = "21.AndroidGoogleStoreA",
			[KCDefineEditor.B_STORE_B_BUILD_FUNC_JENKINS] = "22.AndroidGoogleStoreB",
			[KCDefineEditor.B_STORE_DIST_BUILD_FUNC_JENKINS] = "31.AndroidGoogleStoreDist"
		},

		[EAndroidType.AMAZON] = new Dictionary<string, string>()
		{
			[KCDefineEditor.B_DEBUG_BUILD_FUNC_JENKINS] = "01.AndroidAmazonDebug",
			[KCDefineEditor.B_RELEASE_BUILD_FUNC_JENKINS] = "11.AndroidAmazonRelease",
			[KCDefineEditor.B_STORE_A_BUILD_FUNC_JENKINS] = "21.AndroidAmazonStoreA",
			[KCDefineEditor.B_STORE_B_BUILD_FUNC_JENKINS] = "22.AndroidAmazonStoreB",
			[KCDefineEditor.B_STORE_DIST_BUILD_FUNC_JENKINS] = "31.AndroidAmazonStoreDist"
		}
	};
	...
	public static readonly Dictionary<EStandaloneType, Dictionary<string, string>> B_JENKINS_STANDALONE_SOURCES = new Dictionary<EStandaloneType, Dictionary<string, string>>()
	{
		...
		{
			[KCDefineEditor.B_DEBUG_BUILD_FUNC_JENKINS] = "01.StandaloneMacSteamDebug",
			[KCDefineEditor.B_RELEASE_BUILD_FUNC_JENKINS] = "11.StandaloneMacSteamRelease",
			[KCDefineEditor.B_STORE_A_BUILD_FUNC_JENKINS] = "21.StandaloneMacSteamStoreA",
			[KCDefineEditor.B_STORE_DIST_BUILD_FUNC_JENKINS] = "31.StandaloneMacSteamStoreDist"
		},

		[EStandaloneType.WNDS_STEAM] = new Dictionary<string, string>()
		{
			[KCDefineEditor.B_DEBUG_BUILD_FUNC_JENKINS] = "01.StandaloneWndsSteamDebug",
			[KCDefineEditor.B_RELEASE_BUILD_FUNC_JENKINS] = "11.StandaloneWndsSteamRelease",
			[KCDefineEditor.B_STORE_A_BUILD_FUNC_JENKINS] = "21.StandaloneWndsSteamStoreA",
			[KCDefineEditor.B_STORE_DIST_BUILD_FUNC_JENKINS] = "31.StandaloneWndsSteamStoreDist"
		}
	};
	// 기타 }
	#endregion // 런타임 상수
